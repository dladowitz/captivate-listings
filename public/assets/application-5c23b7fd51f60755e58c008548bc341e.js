...
(function() {
  ...
  jQuery(function() {
    ...
    $('#s3-uploader').bind("s3_upload_complete", function(e, content) {
      return $('#someHiddenField').val(content.url);
    });
    ...
    $('#s3-uploader-neighborhood-background').bind("s3_upload_failed", function(e, content) {
      return alert(content.filename + " failed to upload : " + content.error_thrown);
    });
    $("#s3-uploader-contact-background").S3Uploader();
    return $('#s3-uploader-contact-background').bind("s3_upload_failed", function(e, content) {
      return alert(content.filename + " failed to upload : " + content.error_thrown);
    });
  });

  checkWidth = function(file) {
